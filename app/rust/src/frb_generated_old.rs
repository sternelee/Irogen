...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 487243897;

// Section: executor

lazy_static::lazy_static! {
    pub(crate) static ref FLUTTER_RUST_BRIDGE_HANDLER: std::sync::Arc<flutter_rust_bridge::Handler> = std::sync::Arc::new(flutter_rust_bridge::Handler::new());
}
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        let output_ok =
                            crate::api::iroh_client::get_active_sessions().await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        let output_ok =
                            crate::api::iroh_client::get_active_terminals().await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        3 => wire__rust_lib_app__message_bridge__connect_to_cli_server_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__rust_lib_app__api__iroh_client__connect_to_peer_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__rust_lib_app__api__iroh_client__create_iroh_client_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__rust_lib_app__message_bridge__create_remote_terminal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__rust_lib_app__message_bridge__create_tcp_forwarding_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__rust_lib_app__api__iroh_client__create_terminal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__rust_lib_app__message_bridge__disconnect_from_cli_server_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__rust_lib_app__api__iroh_client__disconnect_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__rust_lib_app__api__iroh_client__generate_qr_code_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__rust_lib_app__api__iroh_client__get_active_sessions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__rust_lib_app__message_bridge__get_active_sessions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__rust_lib_app__api__iroh_client__get_active_terminals_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__rust_lib_app__message_bridge__get_system_status_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__rust_lib_app__message_bridge__get_tcp_forwarding_sessions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__rust_lib_app__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__rust_lib_app__quic_bridge__legacy_quic_deprecated_notice_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__rust_lib_app__message_bridge__list_remote_terminals_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__rust_lib_app__message_bridge__resize_remote_terminal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__rust_lib_app__api__iroh_client__resize_terminal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__rust_lib_app__api__iroh_client__send_terminal_input_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__rust_lib_app__message_bridge__send_terminal_input_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__rust_lib_app__message_bridge__stop_remote_terminal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        29 => wire__rust_lib_app__message_bridge__stop_tcp_forwarding_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        30 => wire__rust_lib_app__api__iroh_client__stop_terminal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        6 => wire__rust_lib_app__message_bridge__create_message_client_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__rust_lib_app__message_bridge__format_forwarding_type_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__rust_lib_app__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        23 => wire__rust_lib_app__message_bridge__parse_endpoint_addr_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__rust_lib_app__message_bridge__validate_terminal_size_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
