...
const dictionaries = {
  en: flatten({
    ...
    chat: {
      ...
      failedToSend: "Failed to send permission response",
      failedToSetMode: "Failed to set permission mode",
      reconnectFailed: "Reconnect Failed",
      reconnectFailedMsg: "Failed to reconnect",
    ...
    devices: {
      ...
      noActiveHostsDesc: "Paste a connection ticket above to link a remote host.",
      connected: "Connected",
  ...
  "zh-CN": flatten({
    ...
    chat: {
      ...
      failedToSend: "发送权限响应失败",
      failedToSetMode: "设置权限模式失败",
      reconnectFailed: "重连失败",
      reconnectFailedMsg: "重连失败",
      reconnected: "会话已重连",
      localAgent: "本地代理",
      copyMessage: "复制消息",
      resendMessage: "重发消息",
    ...
    devices: {
      ...
      noActiveHostsDesc: "在上方粘贴连接票据以链接远程主机。",
      connected: "已连接",
      savedDevices: "已保存的设备",
      clear: "清除",
      active: "活跃",
