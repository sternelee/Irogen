...
// Simple native select wrapper for backward compatibility
...
const LegacySelect: Component<LegacySelectProps> = (props) => {
  const [local, rest] = splitProps(props, ["class", "value", "onChange", "children", "id", "disabled"])
