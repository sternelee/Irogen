        ...
        let handle = tokio::spawn(async move {
            ...
            loop {
                ...
                if !messages_to_process.is_empty() {
                    ...
                    let _ = enhanced_router
                        .route_messages_batch(messages_to_process)
                        .await;
                }
            }
        ...
        let monitor_handle = tokio::spawn(async move {
            loop {
                ...
                if success_rate < 95 && total > 100 {
                    warn!(
                        "Low success rate: {}% (consider increasing resources)",
                        success_rate
                    );
                }
